        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[0, 1, 2].map((i) => (
              <div
                key={i}
                className="bg-gradient-to-br from-card/70 to-background/70 border-border shadow-xl rounded-xl border p-4 sm:p-6"
              >
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  ...
                  <thead>
                    <tr className="border-b border-border">
                      {["Vault", "Asset", "TVL", "APY", ""].map((h, idx) => (
                        <th
                          key={idx}
                          className={`${idx === 4 ? "text-right" : "text-left"} text-muted-foreground text-xs font-medium uppercase tracking-wide py-3`}
                        >
        ...
        >
          ...
          <div className="w-full">
            <div className="h-10 sm:h-12 bg-gradient-to-br from-card to-background backdrop-blur-sm border border-border/50 rounded-lg flex items-center px-2 gap-2">
              {["Positions", "Transactions", "Rewards", "Analytics"].map(
                (t, i) => (
                    ...
                    <thead>
                      <tr className="border-b border-border">
                        {[
                          ...
                          <th
                            key={idx}
                            className="text-left text-muted-foreground text-xs font-medium uppercase tracking-wide py-3"
                          >
                            <UISkeleton className="h-3 w-16" />
                          </th>
                        ))}
                    ...
                    <tbody>
                      {[0, 1, 2].map((r) => (
                        <tr key={r} className="border-b border-border">
                          ...
                          <td className="py-4">
                            <UISkeleton className="h-8 w-28 rounded-md" />
                          </td>
                        </tr>
                      ))}
                    </tbody>
